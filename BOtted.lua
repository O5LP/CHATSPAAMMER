local message = "add Cheezy 5759 for nitro sniper"
...
pcall(function()
	cmdlp.Character.HumanoidRootPart.CFrame = game:GetService("Players"):GetPlayers()[math.random(1, #game:GetService("Players"):GetPlayers())].Character.HumanoidRootPart.CFrame
end)
wait(2)
pcall(function()
	cmdlp.Character.HumanoidRootPart.CFrame = game:GetService("Players"):GetPlayers()[math.random(1, #game:GetService("Players"):GetPlayers())].Character.HumanoidRootPart.CFrame
